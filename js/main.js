...
// Banner links keep smooth-scroll while the tracking code lives directly in HTML.
const setupBannerScroll = () => {
    const bannerLinks = Array.from(document.querySelectorAll('#bannerLink, #bannerLinkMobile'));
...
const initPage = () => {
    applySectionOrder(STATIC_SECTION_ORDER);
    applyAlternatingSectionBackgrounds(STATIC_SECTION_ORDER);
